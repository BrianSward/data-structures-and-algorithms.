...
const toLastNames = people => {
  // Solution code here...
  let step = people.map((v,i) => `${v.firstName} ${v.lastName}`);
  return step;
};
...
const addValues = (arr) => {
  // Solution code here...
  return arr.reduce ((accumulator,value,index)=> accumulator = accumulator + value, 0);
};
...
const addPurchases = (arr) => {
  // Solution code here...
  return arr.reduce ((accumulator,value,index)=> accumulator = accumulator + value.purchasePrice, 0);
};
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  return arr.reduce ((accumulator,value,index)=> index+1, 0);
};
...
const returnNames = (arr) => {
  // Solution code here...
  return arr.reduce ((accumulator,value,index)=> [...accumulator,value.name], []);
};
  // return arr.map((arr,i)=>arr.name)};
...
const reversedString = (str) => {
  // Solution code here...
  return str.split('').reduce((alpha,bravo) => bravo+alpha);
};
/* ------------------------------------------------------------------------------------------------
